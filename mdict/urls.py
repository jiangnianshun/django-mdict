...
urlpatterns = [
    ...
    path('simple2/', views.mdict_index_simple2),
    path('sug/', views.search_suggestion),
    re_path(r'^(\d+)/(.+)/$', views.search_mdd),
    re_path(r'^simple/(\d+)/(.+)/$', views.search_mdd),
    re_path(r'^simple2/(\d+)/(.+)/$', views.search_mdd),
    re_path(r'^(\d+)/(.+)$', views.search_mdd),
    re_path(r'^simple/(\d+)/(.+)$', views.search_mdd),
    re_path(r'^simple2/(\d+)/(.+)$', views.search_mdd),
    ...
    path('simple/getexfile/', views.get_external_file),
    path('simple2/getexfile/', views.get_external_file),
    re_path('getexfile/(.+)', views.get_external_file),
    re_path('simple/getexfile/(.+)', views.get_external_file),
    re_path('simple2/getexfile/(.+)', views.get_external_file),
    path('es/getexfile/', views.get_external_file),
    re_path('es/getexfile/(.+)', views.get_external_file),
    path('audio/', views.search_audio),
    path('simple/audio/', views.search_audio),
    path('simple2/audio/', views.search_audio),
    ...
    re_path(r'^simple2/zim/(\d+)/(.+)$', views.search_zim),
